...
/**
 * Form to configure a Formio 'partners' type component.
 */
const EditForm: EditFormDefinition<PartnersComponentSchema> = () => {
  const intl = useIntl();
  const [isKeyManuallySetRef, generatedKey] = useDeriveComponentKey();
  const {hasAnyError} = useErrorChecker<PartnersComponentSchema>();
...
const defaultValues: PartnersComponentSchema = {
  type: 'partners',
  id: '',
  label: '',
  key: '',
