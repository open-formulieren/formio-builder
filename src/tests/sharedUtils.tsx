...
export const DEFAULT_FORM_TYPE: FormType = 'regular';

export const DEFAULT_FORM_DESIGNER_GROUPS: ComponentGroup[] = [
  {
    name: 'basic',
    components: [
      'textfield',
...
export const DEFAULT_FORM_DESIGNER_PRESETS: PresetComponentDefinition[] = [
  {
