...
export const Multiple: Story = {
  ...
  play: async ({canvasElement}) => {
    ...
    expect(input1).toHaveDisplayValue('1980-01-01');
    ...
    expect(canvas.getByTestId('input-my-datefield[0]')).toHaveDisplayValue('');
    expect(canvas.queryByTestId('input-my-datefield[1]')).not.toBeInTheDocument();
  },
};
